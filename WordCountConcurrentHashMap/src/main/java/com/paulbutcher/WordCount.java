...
public class WordCount {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ConcurrentHashMap<String, Integer> counts = new ConcurrentHashMap<String, Integer>(0x10000);
  ...
  private static void printResult(ConcurrentHashMap<String, Integer> result) {
